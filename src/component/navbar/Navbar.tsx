  ...
  return (
    ...
    className= {`transition-all ${ NavBg ? 'shadow-md bg-[#f9f9ff] dark:bg-[#140f1c]':'fixed bg-transparent'} duration-200 h-[12vh] z-[1000] w-full fixed `}>
      <div className="flex items-center justify-between w-[90%] h-full mx-auto">
        {/* LOGO */}
        <Logo />
        <div className="hidden space-x-10 lg:flex items-center justify-center ms-auto">
          {navLinks.map((link) => {
            return (
              <Link
                href={link.url}
        ...
        <div className="flex items-center space-x-4">
          {/* <a
            href="/cv.pdf"
            className=" hidden px-5 py-2.5 relative rounded-full group  text-white font-medium lg:inline-block"
          >
